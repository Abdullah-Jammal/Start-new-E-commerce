...
const Tiptap = ({val} : {val : string}) => {
  ...
  return (
    <div>
      {editor && (
        <div className='border border-input bg-transparent mb-2 rounded-md'>
          ...
          <Toggle pressed={editor.isActive('bulitList')} onPressedChange={() => editor.chain().focus().toggleBulletList().run()} size={'sm'}>
